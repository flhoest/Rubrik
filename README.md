...
```
![rubrik_logo](https://upload.wikimedia.org/wikipedia/commons/9/9b/Rubrik_Logo.svg) ![php_logo](https://pngimg.com/uploads/php/small/php_PNG50.png)
...
rkGetObjectStorage($clusterConnect,$vmName,$type)
